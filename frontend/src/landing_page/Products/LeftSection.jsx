...
const LeftSection = ({ img, title, description, one, two, google, app }) => {
  return (
    <section className="flex flex-col md:flex-row items-center justify-center gap-16 mt-28 px-6 md:px-20 overflow-hidden">
      {/* Image Left */}
      <motion.div
